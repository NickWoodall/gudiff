...
def parse(*,
  ...
  Args:
    ...
    catch_all_errors: If True, all exceptions are caught and error messages are
      ...
      to propagate.
    simple: for cifs without extra meta-data like from generated pdbs
  ...
  try:
    ...
    if simple: #simple is without header like generated pdb
        valid_chains = _get_protein_chains_simple(parsed_info)
    else:
